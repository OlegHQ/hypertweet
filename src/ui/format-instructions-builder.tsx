...
import type { App } from "src/background-app";

const FormatInstructionBuilder: React.FC<{
  selectedProfileId: string;
  withPreview?: boolean;
  app: App;
}> = ({ selectedProfileId, withPreview, app }) => {
    ...
    const loadSavedOptions = async () => {
      try {
        const savedInstruction =
          await app.ai.getFormatInstructionOptions(selectedProfileId);
