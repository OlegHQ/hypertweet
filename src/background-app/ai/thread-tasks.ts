export enum ThreadTask {
  ...
  PERSPECTIVE = "Share a unique perspective or insight based on the .twitterThread",
  METAPHOR = "Write a smart phrase, metaphor, or simile on the .twitterThread",
  TIP = "Give your experience with the tip if the you've actually tried it for yourself",
}
